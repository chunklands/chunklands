#ifndef __CHUNKLANDS_LIBCXX_JS_H__
#define __CHUNKLANDS_LIBCXX_JS_H__
...
#define JS_IMPL_INITCTOR(CLASS, CLASS_DEF)                  \
public:                                                     \
...
#define JS_DECL_INITCTOR()                      \
public:                                         \
    static Napi::FunctionReference constructor; \
    static JSFunction Initialize(JSEnv env);

#define JS_DEF_INITCTOR(CLASS, CLASS_DEF)                   \
...
#define JS_DEF_INITCTOR_NOCLASSDEF(CLASS)            \
    Napi::FunctionReference CLASS::constructor;      \
    JSFunction CLASS::Initialize(JSEnv env)          \
    {                                                \
...
#define JS_DECL_CB(WHAT) \
protected:               \
    JSValue JSCall_##WHAT(JSCbi info);
#define JS_DECL_CB_VOID(WHAT) \
protected:                    \
    void JSCall_##WHAT(JSCbi info);
#define JS_DECL_CB_STATIC(WHAT) \
protected:                      \
    static JSValue JSCall_##WHAT(JSCbi info);
#define JS_DECL_CB_STATIC_VOID(WHAT) \
protected:                           \
    static void JSCall_##WHAT(JSCbi info);

// Wrap - DEF
#define JS_DEF_WRAP(CLASS) Napi::FunctionReference CLASS::constructor;
#define JS_DEF_SETTER_WRAP(CLASS, WHAT)      \
    void CLASS::JSCall_Set##WHAT(JSCbi info) \
    {                                        \
        js_##WHAT = info[0];                 \
    }
#define JS_DEF_SETTER_OBJECT(CLASS, WHAT)                 \
    void CLASS::JSCall_Set##WHAT(JSCbi info)              \
    {                                                     \
...
#define JS_IMPL_ABSTRACT_WRAP(TYPE, WHAT)               \
protected:                                              \
    JSValue JSCall_As##WHAT(JSCbi info)                 \
    {                                                   \
        return JSExternal<TYPE>::New(info.Env(), this); \
    }
#define JS_IMPL_ABSTRACT_WRAP_SETTER(TYPE, WHAT) \
protected:                                       \
...
#define _JS_IMPL_SETTER_WRAP(TYPE, WHAT, IMPL) \
    JS_ATTR_WRAP(TYPE, WHAT)                   \
protected:                                     \
    void JSCall_Set##WHAT(JSCbi info) IMPL
#define _JS_IMPL_SETTER_OBJECT(WHAT, IMPL) \
protected:                                 \
...
#define JS_ASSERT_MSG(ENV, COND, MSG)        \
    do {                                     \
        if (!(COND)) {                       \
