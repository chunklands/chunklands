#ifndef __CHUNKLANDS_ENGINE_MATH_MATH_INL__
#define __CHUNKLANDS_ENGINE_MATH_MATH_INL__
...
namespace std {
template <class T>
std::ostream& operator<<(std::ostream& os, const chunklands::engine::math::vec1<T>& v)
{
    return os << "vec(" << v.x << ")";
}

template <class T>
std::ostream& operator<<(std::ostream& os, const chunklands::engine::math::vec2<T>& v)
{
    return os << "vec(" << v.x << ", " << v.y << ")";
}

template <class T>
std::ostream& operator<<(std::ostream& os, const chunklands::engine::math::vec3<T>& v)
{
